000100* MAIN.COB GnuCOBOL FAQ example
...
000000         infile-data(line-index) = '-'
000000     ADD 1 TO line-index
000000     END-PERFORM
000000     MOVE infile-record(1:line-index - 1) to low-one
000000     
000000     ADD 1 TO line-index
...
000000     END-IF
000000     END-PERFORM
000000     IF sum-one = 0 then
000000     DISPLAY '0'
000000     ELSE
000000     MOVE sum-one TO out-val(1:7)
000000     MOVE 1 to line-index
...
000000     END-IF
000000     IF sum-two = 0 then
000000     DISPLAY '0'
000000     ELSE
000000     MOVE sum-two TO out-val(1:7)
000000     MOVE 1 to line-index
000000     PERFORM UNTIL (not out-data(line-index) = '0')
000000     ADD 1 to line-index
000000     END-PERFORM
